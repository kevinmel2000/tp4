...
<head>
	...
	<link rel="stylesheet" type="text/css" id="theme" href="<?php echo base_url() ?>assets/css/filza.css" />
	<!-- EOF CSS INCLUDE -->
	<style type="text/css">
		.footer{
	...
	<div class="page-container page-navigation-top page-navigation-top-custom">
		<div class="page-content" style="height: 739px;">
			<div class="page-content-header">
				<img src="<?php echo base_url() ?>/assets/img/fotopongi.jpg" width="60" height= "60">

			</div>
			<ul class="x-navigation x-navigation-horizontal" style="background: #8C9E8B">
						...
						<div class="col-md-9">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="col-md-4">
										<div class="tempatiklan" style="border:ridge;">
										<img src="<?php echo base_url() ?>/assets/img/IKLAN.jpg" width="275" height= "75">
										<p>ini buronan</p>
									</div>
								</div>
					...
					<div class="col-md-3">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<img src="<?php echo base_url() ?>/assets/img/IKLAN.jpg" width="275" height= "75">
								<hr>
								<img src="<?php echo base_url() ?>/assets/img/IKLAN2.jpg" width="275" height= "75">
								<hr>
								<img src="<?php echo base_url() ?>/assets/img/IKLAN3.jpg" width="275" height= "75">
								<hr>
								<img src="<?php echo base_url() ?>/assets/img/IKLAN4.jpg" width="275" height= "75">
								<hr>
							</div>
						</div>
					</div>
